...
import com.memorymakerpeople.memoryrollingpaper.authLogin.UserOAuth2Service;
import com.memorymakerpeople.memoryrollingpaper.utils.oauth2.OAuth2AuthenticationSuccessHandler;
...
//                .antMatchers("/product/create").hasAuthority("SELLER")
                ...
                .antMatchers("/members/**", "/auth/**", "/login/**", "/cards/**", "/papers/**", "/stickers/**", "/").permitAll()
